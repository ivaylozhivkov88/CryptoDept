...
class CalculatePositionSizeUseCaseTest {
    ...
    fun testBasicPositionSizing() {
        ...
        assertEquals("Max loss should be 2% of portfolio", 200.0, result.maxLossUsd, 0.1)
    ...
    fun testGradeCalculation() {
        ...
        assertEquals(
            "Grade should be GOOD for RR 2+",
            true,
            excellentRatio.grade in
                listOf(
                    PositionGrade.GOOD,
