...
@HiltViewModel
class TradePlannerViewModel @Inject constructor() : ViewModel() {
    ...
    fun setInitialParams(symbol: String, entry: Double, sl: Double, tp: Double) {
    ...
    fun setDirection(dir: TradeDirectionType) { _direction.value = dir }
    fun setEntryPrice(price: Double) { _entryPrice.value = price }
    fun setStopLoss(price: Double) { _stopLoss.value = price }
    fun setTakeProfit(price: Double) { _takeProfit.value = price }
