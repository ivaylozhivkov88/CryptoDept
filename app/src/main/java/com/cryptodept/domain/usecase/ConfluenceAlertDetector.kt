...
class ConfluenceAlertDetector
    ...
    constructor() {
        ...
        fun detect(
            ...
            // MACD
            if (macdBullish) {
                bullishSignals.add("MACD BULLISH CROSSOVER")
            } else {
                bearishSignals.add("MACD BEARISH CROSSOVER")
            }

            // EMA
            if (priceAboveEma50) {
                bullishSignals.add("PRICE ABOVE EMA50")
            } else {
                bearishSignals.add("PRICE BELOW EMA50")
            }

            if (priceAboveEma200) {
                bullishSignals.add("PRICE ABOVE EMA200 (BULL MARKET)")
            } else {
                bearishSignals.add("PRICE BELOW EMA200 (BEAR MARKET)")
            }
