...
@Singleton
class BacktesterEngine @Inject constructor(
    ...
    suspend fun run(config: BacktestConfig, ohlcData: List<com.cryptodept.domain.model.OHLCData>): BacktestResult = withContext(Dispatchers.Default) {
