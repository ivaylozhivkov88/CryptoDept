...
class AlertEngine @Inject constructor() {
    ...
    fun evaluateCompositeAlert(
        ...
        val conditionResults = alert.conditions.map { condition ->
            evaluateCondition(
                condition = condition,
        ...
        val overallResult = when (alert.logicOperator) {
    ...
    fun shouldTriggerAlert(alert: CompositeAlert, evaluation: AlertEvaluationResult): Boolean {
